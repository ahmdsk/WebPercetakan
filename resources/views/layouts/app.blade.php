...
<head>
    ...
    <meta charset="utf-8" />
    <title>{{$web['title']}} | {{$perusahaan->nama_perusahaan}}</title>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{route('dashboard')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('landing/img/logo/'.$perusahaan->logo) }}" alt="" height="50" class="mt-3">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('landing/img/logo/'.$perusahaan->logo) }}" alt="" height="75" class="mt-3">
                    </span>
                </a>
                <!-- Light Logo-->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">{{$web['title']}}</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        @foreach ($web['breadcrumb'] as $bc)
