            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{url('/')}}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('landing/img/logo/'.$perusahaan->logo) }}" alt="" height="25">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('landing/img/logo/'.$perusahaan->logo) }}" alt="" height="40">
                        </span>
                    </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{asset('landing/img/testimonials/user-not-found.png')}}"
                                alt="Header Avatar">
